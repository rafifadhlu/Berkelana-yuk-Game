...
public class MQuestGiver : MonoBehaviour, IDataPersistence
{
    ...
    // public menuBaca baca;

    // Start is called before the first frame update

    public void LoadData(GameData data){
        if(data.GameQuestData != null){
            this.quests = data.GameQuestData[2];
            MSJKTInstance.Instance.quests = this.quests;
        }
        RefreshInspector();
    }

    public void SaveData(ref GameData data){
        data.GameQuestData[2] = this.quests;
    }
    ...
    private IEnumerator checkLoadedData(){
        ...
        if (quests != null && quests.questList.Count > 0)
        {
            ...
            Debug.Log("Value From Instance : " + MSJKTInstance.Instance.quests.questList[0].titleMission);
    ...
    public void AcceptQuest(){
        ...
        if (quests != null)
        {
            ...
            {
                MSJKTInstance.Instance.quests = quests;
            }
        }
        else
        {
