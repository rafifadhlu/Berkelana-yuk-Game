...
public class MProcessDataContent
{
    ...
    public void GetCleanDataTP(){
       getRawDataTP = getData.getDataFromTxt("Content","Materi-TP");
    }

    public void GetMaterialData(){
       getRawDataMaterial = getData.getDataFromTxt("Content","Materi-MSJKT-Split");
    }
