...
public class QuestGiver : MonoBehaviour, IDataPersistence
{
    public int idLevel;
    ...
    public void LoadData(GameData data){
        if(data.GameQuestData != null){
            this.quests = data.GameQuestData[0];
            QuestManager.Instance.quests = this.quests;
        }
        RefreshInspector();
    }

    public void SaveData(ref GameData data){
        data.GameQuestData[0] = this.quests;
    }
    ...
    void Start()
    {
        ...
        // Debug.Log("Value From Instance : " + QuestManager.Instance.quests.questList[0].titleMission);
    }
