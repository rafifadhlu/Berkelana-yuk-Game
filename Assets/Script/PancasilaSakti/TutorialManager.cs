...
public class TutorialManager : MonoBehaviour
{
    ...
    {
        "Selamat datang di World Pertama! Disini Kamu punya beberapa navigasi utama.",
        ...
        "Dann untuk memulai seluruh rangkaian, kamu bisa interaksi dengan Bian yaa"
    };

    private string[] IntroductionMission = new string[]
    {
        "Yey kamu sudah interaksi dengan Bian",
        "Kamu bisa liat misi yang diberikan pada panel disamping",
        "Great! Langkah selanjutnya kamu harus mencari titik-titik untuk menyelesaikan misi",
        "Tempat tersebut sudah ditandai, lalu kamu bisa interaksi dan menyimak informasi yang diberikan oleh Septi",
        "Ingatt yaa! harus menyimak. Karena semua yang diberikan akan menjadi bekal di misi terakhir. Terima kasihh!"
    };
